export const SITE_URL = 'https://abc-swyxkit.vercel.app';
export const APPROVED_POSTERS_GH_USERNAME = ['uvacoder'];
export const GH_USER_REPO = 'uvacoder/abc-swyxkit'; // used for pulling github issues and offering comments
...
export const MY_TWITTER_HANDLE = 'VaLandscapes';
